    ...
    return (
        ...
        >
            <div className="daten-content">
                ...
                <p>Sie haben unbeschadet eines verfügbaren verwaltungsrechtlichen oder außergerichtlichen Rechtsbehelfs einschließlich des Rechts auf Beschwerde bei einer Aufsichtsbehörde gemäß <a target="_blank" class="link" href="https://dsgvo-gesetz.de/art-77-dsgvo/">Artikel 77 DSGVO</a> das Recht auf einen wirksamen gerichtlichen Rechtsbehelf, wenn sie der Ansicht ist, dass Ihre, aufgrund dieser Verordnung zustehenden Rechte, infolge einer nicht im Einklang mit dieser Verordnung stehenden Verarbeitung Ihrer personenbezogenen Daten verletzt wurden.</p>
                <h4>Einsatz von Plausible Analytics</h4>
                <p>Ich verwende Plausible Analytics, ein DSGVO-, GDPR, CCPA- und Cookie-Gesetz-konformes Website-Analysetool. Es ist mir egal, wer Sie sind, ich bin nur neugierig, wie Sie die Website nutzen. Deshalb habe ich ein Tool gewählt, das sich auf den Datenschutz konzentriert. Mehr dazu finden sie auf der Website von <a target="_blank" class="link" href="https://plausible.io/data-policy">plausible</a></p>
            </div>
            <div
